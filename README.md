...
# Exercice 11
## Prerequisites
In addition to the steps indicated in the exercice, i also added to `pom.xml` the following dependency : 
```xml
<dependency>
...
```
Because the Cucumber runner added is JUnit 4 (@RunWith(Cucumber.class)), while the project is using JUnit5, so it won’t run unless the JUnit 4 vintage engine is available.
## mvn test logs
```bash
mvn test
[INFO] Scanning for projects...
...
[INFO] --------------------------------[ jar ]---------------------------------
[INFO] 
[INFO] --- jacoco:0.8.11:prepare-agent (prepare-agent) @ bank-application ---
[INFO] argLine set to -javaagent:/home/luca/.m2/repository/org/jacoco/org.jacoco.agent/0.8.11/org.jacoco.agent-0.8.11-runtime.jar=destfile=/home/luca/git/BankApplication-Repo2/target/jacoco.exec
[INFO] 
[INFO] --- resources:3.3.1:resources (default-resources) @ bank-application ---
[INFO] Copying 0 resource from src/main/resources to target/classes
[INFO] 
...
[INFO] -------------------------------------------------------
[INFO] Running com.imt.mines.BankAccountTest
[INFO] Tests run: 3, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.063 s -- in com.imt.mines.BankAccountTest
...
[INFO] Tests run: 1, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.163 s -- in com.imt.mines.bank.bdd.RunBankAccountCucumberTest
[INFO] 
[INFO] Results:
[INFO] 
...
[INFO] 
[INFO] 
[INFO] --- jacoco:0.8.11:report (report) @ bank-application ---
[INFO] Loading execution data file /home/luca/git/BankApplication-Repo2/target/jacoco.exec
[INFO] Analyzed bundle 'bank-application' with 5 classes
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
[INFO] Total time:  2.465 s
[INFO] Finished at: 2026-01-16T09:50:48+01:00
[INFO] ------------------------------------------------------------------------
```